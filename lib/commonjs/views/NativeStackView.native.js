...
var _RetainContext = require("./RetainContext");
...
function NativeStackViewInner(_ref3) {
  ...
  const {
    ...
    hiddenDescriptors,
    retainedKeys
  } = (0, _RetainContext.useRetainContext)(state, navigation, descriptors);
  descriptors = {
    ...hiddenDescriptors,
    ...descriptors
  };
  const routes = hiddenRoutes.concat(state.routes);
  return /*#__PURE__*/React.createElement(_RetainContext.RetainContext.Provider, {
    value: retainContext
